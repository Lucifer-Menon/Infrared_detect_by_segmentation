...
class App(object):
    def __init__(self, model_type='unet'):
        ...
        self.dataset_dir = 'H:/wpn/Infrared-detect-by-segmentation-master/sirst'
        self.train_index = open('H:/wpn/Infrared-detect-by-segmentation-master/sirst/idx_320/train.txt').readlines()
        self.test_index = open('H:/wpn/Infrared-detect-by-segmentation-master/sirst/idx_320/test.txt').readlines()
        self.batch_size = 4
        ...
        self.infer_dir = 'H:/wpn/Infrared-detect-by-segmentation-master/pred'
    ...
    def test(self, infer_dir):
        ...
        infer_imgs = glob.glob('%s/*.jpg' % infer_dir)
    ...
    def generate_ds(self):
        ...
        test_ds = InfraredDataset(self.dataset_dir, self.test_index)
        train_dl = DataLoader(
            train_ds, batch_size=self.batch_size, shuffle=True, collate_fn=collect_batch, num_workers=1)
        test_dl = DataLoader(test_ds, batch_size=self.batch_size,
                             shuffle=False, collate_fn=collect_batch, num_workers=1)
