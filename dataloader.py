...
if __name__ == "__main__":
    dataset_dir = 'H:/wpn/Infrared-detect-by-segmentation-master/sirst'
    image_index = open('H:/wpn/Infrared-detect-by-segmentation-master/sirst/idx_427/trainval.txt').readlines()
